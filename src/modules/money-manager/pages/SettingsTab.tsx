...
export const SettingsTab: React.FC = () => {
  const { settings, updateSettings, updateBudget, resetAllData } = useMoneyStore()
  ...
  return (
    <div className="space-y-5 text-left pb-16 select-none animate-in fade-in duration-200">
        ...
        <Card className="bg-card/30 border border-border/40 rounded-2xl overflow-hidden">
          <CardContent className="p-0 divide-y divide-border/30">
            ...
            <div 
              ...
              className="flex justify-between items-center h-12 px-4 hover:bg-muted/40 transition-colors cursor-pointer"
            >
              <span className="text-xs font-bold text-foreground">Month Starts On</span>
              <div className="flex items-center space-x-1.5 text-muted-foreground">
            ...
            <div 
              ...
              className="flex justify-between items-center h-12 px-4 hover:bg-muted/40 transition-colors cursor-pointer"
            >
              <span className="text-xs font-bold text-foreground">Monthly Budget</span>
              <div className="flex items-center space-x-1.5 text-muted-foreground">
      ...
      <Dialog
        ...
        title="Delete All Money Manager Data"
      >
        <div className="space-y-4 pt-1">
          <div className="flex items-start space-x-3 p-3 bg-red-500/10 text-red-500 rounded-xl">
            <AlertTriangle className="w-5 h-5 shrink-0 mt-0.5" />
            <p className="text-xs leading-relaxed">
              This action will permanently delete all transactions, budgets, goals, and customized settings from your local device and the cloud. This cannot be undone.
            </p>
          </div>
          <div className="flex space-x-3 justify-end">
