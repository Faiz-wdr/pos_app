            ...
            {themeOptions.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg text-xs font-bold transition-all cursor-pointer ${isSelected
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex bg-muted p-0.5 rounded-lg border border-border/60">
              <button
                ...
                className={`px-3 py-1 text-xs font-bold rounded-md transition-all cursor-pointer ${clockType === 'digital'
              ...
              <button
                ...
                className={`px-3 py-1 text-xs font-bold rounded-md transition-all cursor-pointer ${clockType === 'analog'
                    ? 'bg-background text-foreground shadow-xs'
                    : 'text-muted-foreground hover:text-foreground'
                  }`}
              >
          ...
          <div className="flex flex-col space-y-2">
            {dateFormats.map((f) => (
              <button
                ...
                className={`w-full flex items-center justify-between p-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${dateFormat === f.value
