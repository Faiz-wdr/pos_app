...
export const TomorrowPage = () => {
  ...
  const [activeDateKey, setActiveDateKey] = useState(tomorrowKey)
  ...
  return (
    <div className="flex-1 flex flex-col space-y-3 pb-24 text-left select-none relative">
      {/* Header Date & Night Planning Header */}
      <div className="flex flex-col">
        ...
        <h1 className="text-lg font-extrabold text-foreground tracking-tight flex items-center space-x-1.5 leading-none mt-0.5">
      ...
      <div className="flex-1 flex flex-col space-y-3">
        ...
        {activeTasks.length === 0 && completedTasks.length === 0 ? (
          <EmptyState type="tomorrow" onAction={handleOpenAdd} />
        ) : (
